...
CREATE TABLE country (
    ...
    name VARCHAR(100) NOT NULL UNIQUE, -- Agregado UNIQUE para nombres de países
...
-- Asegúrate de que los id_country corresponden a los países insertados
-- Puedes obtener los IDs usando SELECT id, name FROM country;
...
-- Procedimientos Almacenados (ABM para city - Ejercicio 2)

-- Procedimiento: Obtener datos de una ciudad por ID o nombre
-- Se puede adaptar para buscar por nombre si se desea, pero por ID es más preciso.
...
-- Procedimientos Almacenados Adicionales (Ejercicio 2)
